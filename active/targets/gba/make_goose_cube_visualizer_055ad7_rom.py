...
def build_rom() -> bytes:
    ...
    rom[0xA0:0xAC] = b"GOOSCUBE055 "
    rom[0xAC:0xB0] = b"GG55"
    rom[0xB0:0xB2] = b"01"
    rom[0xB2] = 0x96
    rom[0xBC] = 0x00
...
def main() -> None:
    out_path = Path(__file__).with_name("goose_cube_visualizer_055ad7.gba")
    fallback_path = out_path.with_name("goose_cube_visualizer_055ad7.next.gba")
